...
def trainExcept(folder_exclude):
	print("doing "+folder_exclude)
	path = './lemm_stop'
	...
	f  = open('train/probs_'+folder_exclude+'.csv', 'w', newline='')
	...
	f  = open('train/trained'+folder_exclude+'.csv', 'w', newline='')
	writer = csv.writer(f, delimiter=',')
